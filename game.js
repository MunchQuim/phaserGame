...
function preload() {
    //background
    //4 mas lejano
    this.load.image('background4', '/public/assets/background/background4.png');
    //3 con algo de movimiento
    this.load.image('background3', '/public/assets/background/background3.png');
    //2 movimiento lento
    this.load.image('background2', '/public/assets/background/background2.png');
    //1 movimiento
    this.load.image('background1', '/public/assets/background/background1.png');

    //cargamos el enemigo basico
    this.load.spritesheet('enemy', '/public/assets/enemigos/enemigo1.png', { frameWidth: 64, frameHeight: 64 });

    //cargamos el proyectil
    this.load.image('proyectil', '/public/assets/proyectiles/proyectil.png');

    // cargamos el sprite del personaje principal
    this.load.spritesheet('phaser', '/public/assets/main/CorbetaSprite.png', { frameWidth: 64, frameHeight: 64 }); // personaje principal

    //explosiones
    this.load.spritesheet('explosion1', '/public/assets/explosion1.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('explosion2', '/public/assets/explosion2.png', { frameWidth: 866 / 6, frameHeight: 288 });
}
function create() {
    this.entidades = {};
    // fisicas del mundo
